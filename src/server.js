...
const TEAMS = {
  nhl: [
    ...
    { abbrev: 'LAK', name: 'Los Angeles Kings', city: 'Los Angeles', streamName: 'la-kings', color: '#111111' },
  ...
  nba: [
    ...
    { abbrev: 'LAC', name: 'Los Angeles Clippers', city: 'Los Angeles', streamName: 'la-clippers', color: '#C8102E' },
    { abbrev: 'LAL', name: 'Los Angeles Lakers', city: 'Los Angeles', streamName: 'la-lakers', color: '#552583' },
  ...
  mlb: [
    ...
    { abbrev: 'LAA', name: 'Los Angeles Angels', city: 'Los Angeles', streamName: 'la-angels', color: '#BA0021' },
    { abbrev: 'LAD', name: 'Los Angeles Dodgers', city: 'Los Angeles', streamName: 'la-dodgers', color: '#005A9C' },
  ...
  nfl: [
    ...
    { abbrev: 'LAC', name: 'Los Angeles Chargers', city: 'Los Angeles', streamName: 'la-chargers', color: '#0080C6' },
    { abbrev: 'LAR', name: 'Los Angeles Rams', city: 'Los Angeles', streamName: 'la-rams', color: '#003594' },
